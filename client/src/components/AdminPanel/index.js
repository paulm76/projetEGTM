...
import EscapeMangopay from '../EscapeMangopay'
export default class AdminPanel extends Component {
  ...
  render() {
      ...
      return(
        <div>
          <div style={{ display: 'flex' }}>
            ...
            <h2 style={{ marginTop: '20px' }}><Button id="EscapeMangopay" onClick={ (event) => this.updateOnglet(event) }>Ajouter Un Etablissement sur Mangopay</Button></h2>
          </div>
          <div>
            <ValidTeam />
          </div>
    ...
    } else if (this.state.onglet === 'EscapeMangopay'){
      return(
        <div>
          <div style={{ display: 'flex' }}>
            <h2 style={{ marginTop: '20px' }}><Button id="ValidTeam" onClick ={ (event) => this.updateOnglet(event) }>Valider les equipes</Button></h2>
